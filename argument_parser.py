...
class ARGUMENT_PARSER(Tap):
    ...
    device: str = "mps:0" #["mps:0", "cuda:0", "cpu"] TODO: reimplement as enum
    HF_TOKEN: str = None
    ...
    sparse_arg_names = ["ablation_kind", "importance_percentage", "sparse_implementation", "k_param", "n_param", "m_param"]
    ...
    ft_arg_names = ["dataset", "lora_rank", "lora_alpha", "lora_dropout", "target_modules", \
