...
def dummy_launch(model, tokenizer):
    ...
    decoded = tokenizer.decode(tok_text["input_ids"][0],
...
def main(parsed_arguments):
    ...
    if parsed_arguments.lora_finetune:
        ...
        train_model(
            ...
            per_device_train_batch_size=parsed_arguments.per_device_train_batch_size,  # type: ignore # noqa: E501
            per_device_eval_batch_size=parsed_arguments.per_device_eval_batch_size,  # type: ignore # noqa: E501
            num_train_epochs=parsed_arguments.num_train_epochs,
            weight_decay=parsed_arguments.weight_decay,
        )

    # Evaluate model
    model = HFLM(pretrained=model, device="mps:0")
    ...
    # list1, list2 = zip(*sorted(zip(modules_importances, [i for i in range(28)])))  # type: ignore # noqa: E501
